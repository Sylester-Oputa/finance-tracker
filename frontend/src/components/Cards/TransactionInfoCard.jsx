  ...
  return (
    <div className="group relative flex items-center gap-4 mt-2 p-3 rounded-lg hover:bg-gray-300/60">
      ...
      <div className="flex-1 flex items-center justify-between">
        <div>
          <p className="text-sm text-[#181821] font-medium">{title}</p>
        ...
        <div className="flex items-center gap-2">
          {!hideDeleteBtn && (
            <button
              className="text-gray-600 hover:text-red-500 group-hover:opacity-100 transition-opacity cursor-pointer"
              onClick={onDelete}
            >
              <LuTrash2 size={18} />
            </button>
